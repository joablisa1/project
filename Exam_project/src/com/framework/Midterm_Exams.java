...
public class Midterm_Exams extends JDialog implements ActionListener {

	private static Midterm_Exams subjectform = null;
	...
	MidtermDaoImpl db=null;

	public Midterm_Exams() {
		super(WmvcFrames.getTheFrame(), "MidTerm Exams Form", true);
		db = new MidtermDaoImpl();
	}

	public static Midterm_Exams getinstance() {
		if (subjectform != null) {
			subjectform = new Midterm_Exams();
		}
		return subjectform;
